...
// Styles combines Leafpress's embedded stylesheet with the optional contents
// of the CLI's style.css (or the renderer's styleCSS input).
func Styles(userCSS string) string {
