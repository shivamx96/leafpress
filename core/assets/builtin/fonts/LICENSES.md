...
The woff2 files in this directory are the latin/latin-ext variable-weight
subsets served by Google Fonts. All three families are licensed under the
...
The curated set is deliberately Latin-focused (latin + latin-ext subsets);
other scripts fall back to the system font stacks.
