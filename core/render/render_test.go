...
func TestInvalidInput(t *testing.T) {
	tests := []struct {
		...
		{"fragment slug", `{"render":{"slug":"g"},"content":{"pages":[{"slug":"has#fragment","markdown":"x"}]}}`},
		{"query slug", `{"render":{"slug":"g"},"content":{"pages":[{"slug":"has?query","markdown":"x"}]}}`},
		{"encoded slug", `{"render":{"slug":"g"},"content":{"pages":[{"slug":"has%20space","markdown":"x"}]}}`},
		{"unsafe garden slug", `{"render":{"slug":"has#fragment"}}`},
